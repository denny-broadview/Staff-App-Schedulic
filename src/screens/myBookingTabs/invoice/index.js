        ...
        <View>
          ...
          <View style={{padding: 16, flex: 1}}>
            <View style={styles.invoicebottom}>
              <View
                style={{padding: 12, backgroundColor: '#EEF5FF', height: 280}}>
                <View
                  style={{
                    flexDirection: 'row',
                  ...
                  <View>
                    <Text style={{fontSize: 18, color: '#1273F6'}}>
                      {' '}
                      {String.invoice.Businessname}{' '}
                    </Text>
                    <Text
                      style={{
                        fontSize: 16,
                  ...
                  <View>
                    <Text style={{fontSize: 22, color: '#1273F6'}}>
                ...
                <View
                  ...
                  <View>
                    ...
                    <Text
                      style={{fontSize: 16, color: '#0A0A0A', marginTop: 12}}>
                      {' '}
                      Surat,gujarat
                    </Text>
              ...
              <View style={{padding: 12}}>
                <View
                  ...
                  <Text style={styles.commontopheading}>
                ...
                <View style={{flexDirection: 'row'}}>
                  ...
                  <View style={{width: '60%'}}>
                    <View style={styles.totalDetails}>
                      ...
                      <Text style={{fontSize: 16, color: '#6D5959'}}>
                        {' '}
                        ₹2,500.00{' '}
                      </Text>
                    </View>
