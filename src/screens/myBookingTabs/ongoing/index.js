    ...
    try {
      ...
      const granted = await PermissionsAndroid.request(
        PermissionsAndroid.PERMISSIONS.ACCESS_FINE_LOCATION,
        {
          ...
          message:
            'Schedulics needs access to your current location so you can share or track for a ride',
        },
      );
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.container}>
        <View style={{ justifyContent: 'center', flex: 1 }}>
          ...
          <FlatList
            ListEmptyComponent={
              loading == false && refreshing == false ? noItemDisplay() : null
            }
            data={data}
            // inverted={true}
            renderItem={({ item, index }) => (
              <View style={styles.mainView}>
                ...
                <View style={styles.topView}>
                  <Text style={styles.bookingTextDate1}>
                    {' '}
                    ...
                    {item.order_status == 'AC' &&
                      ...
                      <>
                        ...
                        <TouchableOpacity
                          ...
                          <Text style={styles.btnText}>
                            {' '}
                            {String.MyBookingTab.Getting_Late}{' '}
                          </Text>
                        </TouchableOpacity>
                      </>
                    ) : null}
